            ...
            <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div class="card-product overflow-hidden group">
                    ...
                    <div class="relative h-48 overflow-hidden bg-slate-100">
                        ...
                        <!-- Wishlist Button -->
                        <button class="absolute top-3 right-3 w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-slate-400 hover:text-red-500 transition-colors transform hover:scale-110 active:scale-95" title="Add to wishlist">
                        ...
                        <!-- Sale Badge (Optional) -->
                        <div class="absolute bottom-3 left-3 bg-red-500 text-white px-3 py-1 rounded-full text-xs font-semibold">
                            -15%
                        </div>
                    </div>
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="font-bold text-slate-900 truncate mb-2 group-hover:text-coffee-700">{{ $product->nama }}</h3>
                        ...
                        <div class="flex items-center gap-2 mb-3">
                            ...
                            <span class="text-xs text-slate-500">(124 reviews)</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <span class="text-sm text-slate-400 line-through ml-2">Rp {{ number_format($product->harga * 1.15, 0, ',', '.') }}</span>
                            </div>
                            <form action="{{ route('customer.addToCart') }}" method="POST" class="inline">
                                @csrf
                                <input type="hidden" name="product_id" value="{{ $product->id }}">
                                <button type="submit" class="w-9 h-9 rounded-full bg-coffee-700 text-white hover:bg-coffee-800 transition-all flex items-center justify-center shadow-md transform hover:scale-110 active:scale-95">
